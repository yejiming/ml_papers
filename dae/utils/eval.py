from dae.utils.flags import *
from dae.utils.data import fill_feed_dict as fill_feed_dict
...
def do_eval(tag, sess, eval_correct, images_placeholder,
    ...
    print("%s: Num examples: %d  Num correct: %d  Precision @ 1: %0.04f" % (tag, num_examples, true_count, precision))
