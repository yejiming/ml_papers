...
flags.DEFINE_integer("hidden3_units", 2000, "Number of units in hidden layer 3.")
...
flags.DEFINE_integer("finetuning_epochs", 5, "Number of training epochs for fine tuning supervised step")
...
flags.DEFINE_string("chkpt_dir", "./chkpts", "Directory to put the model checkpoints")
