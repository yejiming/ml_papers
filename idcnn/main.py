...
from idcnn.model import Model
from idcnn.loader import load_sentences, update_tag_scheme
from idcnn.loader import char_mapping, tag_mapping
from idcnn.loader import augment_with_pretrained, prepare_dataset
from idcnn.utils import get_logger, make_path, clean, create_model, save_model
from idcnn.utils import print_config, save_config, load_config, test_ner
from idcnn.data_utils import load_word2vec, create_input, input_from_line, BatchManager
            ...
            for batch in train_manager.iter_batch(shuffle=True):
                ...
                if step % FLAGS.steps_check == 0:
                    ...
                    logger.info("iteration:{} step:{}/{}, ""NER loss:{:>9.6f}"
                                .format(iteration, step % steps_per_epoch, steps_per_epoch, np.mean(loss)))
                    loss = []
