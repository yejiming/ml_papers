...
from idcnn.utils import result_to_json
from idcnn.data_utils import iobes_iob
...
class Model(object):
    ...
    def idcnn_layer(self, model_inputs, name=None):
        ...
        with tf.variable_scope("idcnn" if not name else name):
            ...
            """
            layerInput = tf.nn.conv2d(model_inputs, filter_weights, strides=[1, 1, 1, 1],
    ...
    def project_layer(self, idcnn_outputs, name=None):
        """
    ...
    def loss_layer(self, project_logits, lengths, name=None):
        ...
        with tf.variable_scope("crf_loss" if not name else name):
            ...
            log_likelihood, self.trans = crf_log_likelihood(inputs=logits, tag_indices=targets,
                                                            transition_params=self.trans, sequence_lengths=lengths + 1)
