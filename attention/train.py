...
from attention.hyperparams import Hyperparams as hp
from attention.data_load import get_batch_data, load_de_vocab, load_en_vocab
...
class Graph:
    ...
    def __init__(self, is_training=True):
        ...
        with self.graph.as_default():
            ...
            self.preds = tf.cast(tf.argmax(self.logits, axis=-1), dtype=tf.int32)
            self.istarget = tf.cast(tf.not_equal(self.y, 0), dtype=tf.float32)
